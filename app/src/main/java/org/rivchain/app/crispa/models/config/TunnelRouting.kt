...
data class TunnelRouting (
	...
	@SerializedName("iPv6Sources") var iPv6Sources : List<String>, // Optional IPv6 source subnets which are allowed to be tunnelled in addition to this node's Mesh address/subnet. If not specified, only traffic originating from this node's Mesh address or subnet will be tunnelled.
