...
class AboutActivity:AppCompatActivity() {
    ...
    companion object {
        ...
        @JvmStatic var about = "<body style=\"background-color:#343334;\">\n" +
                ...
                "<p>\n" +
                "<font style=\"font-size: 10pt\" color=\"#ffffff\">Mesh is an early-stage implementation of a fully end-to-end encrypted IPv6 network. I\n" +
                "t is lightweight, self-arranging, supported on multiple platforms and allows pretty much any IPv6-capable application to communicate securely with other Mesh nodes.\n" +
                "Mesh does not require you to have IPv6 Internet connectivity - it also works over IPv4.</font></p>\n" +
                ...
                "</font></p>\n" +
                "\n" +
                "<font class=\"western\" style=\"font-size: 14pt\" color=\"#ffffff\"><b>Is Mesh safe?</b></font>\n" +
                "<p>\n" +
                "<font style=\"font-size: 10pt\" color=\"#ffffff\">All traffic sent across the Mesh network is encrypted end-to-end. Assuming that our crypto is solid, it cannot be decrypted or read by any intermediate nodes, and can only be decrypted by the recipient for which it was intended. However, please note that Mesh has not been officially externally audited.\n" +
                "</font></p>\n" +
                "\n" +
                "<font class=\"western\" style=\"font-size: 14pt\" color=\"#ffffff\"><b>Is Mesh stable?</b></font>\n" +
                "<p>\n" +
                "<font style=\"font-size: 10pt\" color=\"#ffffff\">Our official stance is that it is still alpha software. Expect things to not be wholly smooth, and expect to have to upgrade often to the latest builds. That said, there is a small community of users who have not experienced any stability problems so far. Mesh very rarely crashes.\n" +
                "</font></p>\n" +
                "\n" +
                "<font class=\"western\" style=\"font-size: 14pt\" color=\"#ffffff\"><b>Is Mesh anonymous?</b></font>\n" +
                "<p>\n" +
                "<font style=\"font-size: 10pt\" color=\"#ffffff\">It is not a goal of the Mesh project to provide anonymity. Your direct peers may be able to determine your location if, for example, you are peering over the Internet.\n" +
                "</font></p>\n" +
                "\n" +
                ...
                "While Mesh does transport only IPv6 traffic internally, you do not need an IPv6 internet connection to peer with other Mesh users. You can peer with other Mesh nodes over either IPv4 or IPv6.\n" +
                "</font>\n" +
                "<p>\n" +
                "<font class=\"western\" style=\"font-size: 14pt\" color=\"#ffffff\"><b>Will Mesh conflict with my network routing?</b></font>\n" +
                "<p>\n" +
                "<font style=\"font-size: 10pt\" color=\"#ffffff\">Mesh uses the 0200::/7 range, which is a range deprecated by the IETF. It has been deprecated since 2004, pending changes to an RFC which simply never materialised 14 years later. It was decided to use this range instead of fc00::/7 (which is more typically allocated to private networks) in order to prevent conflicts with existing ULA ranges.\n" +
                ...
                "<p>\n" +
                "<font style=\"font-size: 10pt\" color=\"#ffffff\">Mesh only loads the configuration at startup. Restart the Mesh process or service to load the new configuration.\n" +
                "</font></p>\n" +
                "\n" +
                "<font class=\"western\" style=\"font-size: 14pt\" color=\"#ffffff\"><b>I’m running Mesh on a machine that is directly reachable from the Internet. Does this mean anyone can peer with me?</b></font>\n" +
                "<p>\n" +
                ...
                "<p>\n" +
                "<font style=\"font-size: 10pt\" color=\"#ffffff\">\n" +
                "Alternatively, you can limit who can peer with you by modifying the AllowedEncryptionPublicKeys option in your Mesh configuration. When this list is empty, any remote node is allowed to peer with you.\n" +
                "</font>\n" +
                "<p>\n" +
                "<font style=\"font-size: 10pt\" color=\"#ffffff\">\n" +
                ...
                "</font></p>\n" +
                "\n" +
                "<font class=\"western\" style=\"font-size: 14pt\" color=\"#ffffff\"><b>I am running Mesh from behind a NAT. Will this affect my connectivity?</b></font>\n" +
                "<p>\n" +
                "<font style=\"font-size: 10pt\" color=\"#ffffff\">To accept incoming peerings, you will probably need to configure port forwarding on your router/gateway. Mesh listens on the port number specified in the Listen setting, so forward this port to the machine that runs Mesh.\n" +
                "<p>\n" +
                "<font style=\"font-size: 10pt\" color=\"#ffffff\">\n" +
                ...
                "</font></p>\n" +
                "\n" +
                "<font class=\"western\" style=\"font-size: 14pt\" color=\"#ffffff\"><b>I want to run an Mesh router to provide connectivity for other people, but I don’t want them to be able to reach my own machine.</b></font>\n" +
                "<p>\n" +
                "<font style=\"font-size: 10pt\" color=\"#ffffff\">You can set the IfName configuration setting to \"none\". This will load Mesh, but will not create a TUN/TAP adapter, meaning that your host will not be exposed to the Mesh network. This does of course mean that you won’t be able to send any traffic from that node to Mesh either\n" +
                "</font></p>\n" +
                "\n" +
                "<font class=\"western\" style=\"font-size: 14pt\" color=\"#ffffff\"><b>Does Mesh work alongside an existing VPN?</b></font>\n" +
                "<p>\n" +
                "<font style=\"font-size: 10pt\" color=\"#ffffff\">Yes, Mesh should not interfere with existing VPNs. VPN traffic can be sent while using Mesh.\n" +
                "</font></p>\n" +
                "\n" +
                ...
                "\n" +
                "<font style=\"font-size: 10pt\" color=\"#ffffff\">macOS has an application firewall, therefore any firewall policies applied on other interfaces will also apply to the Mesh interface.\n" +
                "</font></p>\n" +
                "\n" +
